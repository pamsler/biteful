...
# =============================================================================
# Meal Planner - Docker Hub Push Script
# =============================================================================
...
build_image() {
    ...
    print_info "Platform: linux/amd64,linux/arm64"
    ...
    if ! docker buildx inspect meal-planner-builder &> /dev/null; then
        print_info "Creating buildx builder..."
        docker buildx create --name meal-planner-builder --use --bootstrap
    else
        docker buildx use meal-planner-builder
    fi

    # Build with buildx for multi-platform and attestation
    docker buildx build \
...
main() {
    echo ""
    print_header "Meal Planner - Docker Hub Push"
    echo ""
