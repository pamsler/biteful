...
export const WeekPlanner: React.FC = () => {
  ...
  const handleSaveMeal = async (meal: Meal) => {
    try {
      ...
      setError('Fehler beim Speichern der Mahlzeit');
      ...
      <Layout title="Wochenplaner">
        <div className="flex items-center justify-center min-h-[calc(100vh-4rem)]">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mt-6 font-medium">Lade Wochenplaner...</p>
          </div>
        </div>
      </Layout>
    );
        ...
        <div className="mb-4 sm:mb-6 grid grid-cols-3 gap-2 sm:gap-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl shadow-md p-3 sm:p-4 border border-gray-100 dark:border-gray-700">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400">Mahlzeiten</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl shadow-md p-3 sm:p-4 border border-gray-100 dark:border-gray-700">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400">Einkaufsliste</p>
