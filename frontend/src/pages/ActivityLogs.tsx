...
export function ActivityLogs() {
  ...
  const actionTypes = [
    ...
    { value: 'SHOPPING_ADD', label: `${t('shoppingList.title')}: ${t('common.add')}` },
    { value: 'SHOPPING_REMOVE', label: `${t('shoppingList.title')}: ${t('common.delete')}` },
    { value: 'SHOPPING_CHECK', label: `${t('shoppingList.title')}: ${t('common.success')}` },
    { value: 'MEAL_CREATE', label: `${t('weekPlanner.title')}: ${t('common.add')}` },
    { value: 'MEAL_UPDATE', label: `${t('weekPlanner.title')}: ${t('common.edit')}` },
    { value: 'MEAL_DELETE', label: `${t('weekPlanner.title')}: ${t('common.delete')}` },
  ];

  if (loading && logs.length === 0) {
    return (
      <Layout title={t('activityLogs.title')}>
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-gray-900 dark:text-white">{t('activityLogs.title')}</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400">{total} {t('activityLogs.title')}</p>
              </div>
            </div>
            ...
            {totalPages > 1 && (
              <div className="mt-8 flex items-center justify-center gap-2">
                ...
                <span className="px-4 py-2 text-gray-700 dark:text-gray-300">
                  {t('shoppingList.page')} {currentPage} {t('shoppingList.of')} {totalPages}
                </span>
