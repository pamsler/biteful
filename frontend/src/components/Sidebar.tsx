...
import { Calendar, ShoppingCart, BookOpen, Pin, X, ChefHat, Settings, Activity } from 'lucide-react';
...
export function Sidebar() {
  ...
  const navItems = [
    { path: '/', icon: Calendar, label: 'Wochenplan', color: 'from-primary-500 to-primary-600' },
    { path: '/shopping', icon: ShoppingCart, label: 'Einkaufsliste', color: 'from-green-500 to-emerald-600' },
    { path: '/recipes', icon: BookOpen, label: 'Rezepte', color: 'from-orange-500 to-red-600' },
    { path: '/activity-logs', icon: Activity, label: 'Aktivitäten', color: 'from-purple-500 to-purple-600' },
  ];
      ...
      >
        ...
        <div className="h-16 px-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900 dark:text-white">Wochenplaner</h2>
            </div>
          </div>
