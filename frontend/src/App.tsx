...
const LoadingSpinner = () => {
  // Die i18n-Funktion ist möglicherweise noch nicht initialisiert beim ersten Laden
  const loadingText = localStorage.getItem('language') === 'en' ? 'Loading...' : 'Lädt...';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-gray-600 dark:text-gray-300 mt-6 font-medium">{loadingText}</p>
      </div>
    </div>
  );
};
